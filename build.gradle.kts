...
tasks.register<Copy>("copyModJar") {
    ...
    into("C:/Users/enzog/AppData/Roaming/ModrinthApp/profiles/Fabric 1.21.8 Testing/mods")
}
...
kotlin {
    compilerOptions {
        freeCompilerArgs.addAll("-Xnested-type-aliases", "-Xcontext-sensitive-resolution")
    }
}